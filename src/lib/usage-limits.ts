export const USAGE_LIMITS = {
  MAX_UPLOAD_FILE_SIZE_BYTES: 3 * 1024 * 1024,
  MAX_AI_PROCESS_FILE_SIZE_BYTES: 3 * 1024 * 1024,

  MAX_UPLOADS_PER_DAY: 8,

  MAX_AI_PROCESSES_PER_HOUR: 4,
  MAX_AI_PROCESSES_PER_DAY: 10,

  MAX_TEXT_CHARS_FOR_AI: 80_000,
  MAX_SPREADSHEET_SHEETS_FOR_AI: 5,
};
