...
const rules = [
  ...
  // =========================
  {
    ...
    ruleText:
      "For GST review in India, Actic Finance should check approved documents for GST returns, sales invoices, purchase invoices, GSTIN references, tax summaries, input tax credit indicators, output tax indicators, and period coverage. Actic Finance must not file GST returns or calculate final GST liability unless verified rate, turnover, input credit, place-of-supply, and return-period rules are available.",
  ...
  },
  {
    ...
    ruleText:
      "Actic Finance may refer to GST Council CGST rate notification source coverage to tell the user that GST rates must be verified against current official rate notifications. Actic Finance should not assume a GST rate for a product or service unless a verified rate rule exists for that item/category.",
  ...
  },
  {
    ...
    ruleText:
      "For India GST compliance questions, Actic Finance should warn that GST tax notifications and amendments must be checked from official GST Council/CBIC sources. If no specific verified notification rule is present, Actic Finance should give only a checklist and recommend professional verification.",
  ...
  },
  {
    ...
    ruleText:
      "Before GST return guidance, Actic Finance should check whether approved documents cover the relevant tax period, sales invoices, purchase invoices, GST returns, credit/debit notes, tax summaries, and reconciliation support. Missing period coverage or unapproved documents should be flagged clearly.",
    sourceName: "CBIC GST portal",
    sourceUrl: "https://cbic-gst.gov.in/",
    sourcePublishedAt: null,
    effectiveFrom: "2025-04-01",
  ...
  },
  {
    ...
    ruleText:
      "For Indian businesses or professionals, Actic Finance should use this source family to identify that income from business/profession requires appropriate income-tax return readiness checks. Actic Finance should check approved financial statements, profit/loss, expense records, TDS records, and prior return references before giving filing-readiness guidance.",
    sourceName:
  ...
  },
  {
    ...
    ruleText:
      "For Indian TDS-related questions, Actic Finance should check whether approved records include TDS certificates, TDS payment references, payroll records, contractor/vendor payment records, and tax deduction summaries. If not present, Actic Finance should recommend professional verification before filing or claiming deductions.",
    sourceName: "Income Tax Department, Government of India",
    sourceUrl: "https://www.incometax.gov.in/",
    sourcePublishedAt: null,
    effectiveFrom: "2025-04-01",
  ...
  },
  {
    ...
    ruleText:
      "For expense deduction readiness, Actic Finance should check whether expenses are supported by invoices, bills, receipts, bank statements, payment references, payroll records where applicable, and period matching. Actic Finance should not decide final allowability without verified tax-rule coverage and professional review.",
    sourceName: "Income Tax Department, Government of India",
    sourceUrl: "https://www.incometax.gov.in/",
    sourcePublishedAt: null,
    effectiveFrom: "2025-04-01",
  ...
  },
  {
    ...
    ruleText:
      "Actic Finance should compare approved sales invoices, purchase invoices, GST returns, credit notes, debit notes, and bank records for obvious missing periods or document gaps. Actic Finance should not claim final GST reconciliation accuracy without complete official-return and ledger data.",
    sourceName: "CBIC GST portal",
    sourceUrl: "https://cbic-gst.gov.in/",
    sourcePublishedAt: null,
    effectiveFrom: "2025-04-01",
  ...
  // =========================
  {
    ...
    ruleText:
      "For United States businesses, Actic Finance should classify federal tax readiness into income tax, estimated taxes, self-employment tax, employment taxes, and excise tax where applicable. The business form affects which taxes apply. Actic Finance should not determine final federal or state tax liability without verified entity, state, and filing facts.",
  ...
  },
  {
    ...
    ruleText:
      "Actic Finance should flag that federal income tax is generally pay-as-you-go through withholding or estimated taxes. For businesses and self-employed users, Actic Finance should check income timing, prior-year return data, estimated payments, and whether quarterly planning should be reviewed by a CPA.",
  ...
  },
  {
    ...
    ruleText:
      "For US self-employed individuals, Actic Finance should check whether self-employment income, business expenses, estimated tax payments, and prior-year return information are available. Actic Finance may mention that IRS self-employment tax guidance should be verified, but should not calculate final self-employment tax without complete verified rules and CPA review.",
  ...
  },
  {
    ...
    ruleText:
      "For US businesses with employees, Actic Finance should check whether payroll records, wage reports, withholding records, employer tax forms, and period coverage are available. Actic Finance should not submit payroll tax filings or certify employment tax liability.",
    sourceName: "IRS — Business Taxes",
    sourceUrl: "https://www.irs.gov/businesses/business-taxes",
    sourcePublishedAt: "2026-04-17",
    effectiveFrom: "2026-01-01",
  ...
  },
  {
    ...
    ruleText:
      "Actic Finance should warn that excise taxes may apply to specific industries, products, or activities. If the business sells regulated or excise-taxable goods/services, Actic Finance should recommend checking IRS excise tax rules and a CPA. Actic Finance should not assume excise tax applies without business activity details.",
    sourceName: "IRS — Business Taxes",
    sourceUrl: "https://www.irs.gov/businesses/business-taxes",
    sourcePublishedAt: "2026-04-17",
    effectiveFrom: "2026-01-01",
  ...
  },
  {
    ...
    ruleText:
      "For US tax year 2026 individual or pass-through owner questions, Actic Finance may reference that IRS publishes tax-year 2026 inflation adjustments. Actic Finance should not apply brackets to calculate final tax unless filing status, taxable income, entity structure, deductions, credits, state rules, and verified rules are complete.",
  ...
  },
  {
    ...
    ruleText:
      "For US sales tax questions, Actic Finance should state that sales tax is generally state/local-specific and requires state tax authority rules, business nexus, product/service category, location, exemption status, and filing period. Actic Finance should not calculate US sales tax from IRS federal data alone.",
  ...
  },
  {
    ...
    ruleText:
      "Actic Finance should check approved documents for income records, expense records, payroll records if applicable, estimated tax payment records, prior returns, entity type, EIN information if available, and state/local tax records. Missing items should be listed as preparation gaps.",
    sourceName: "IRS — Filing and paying your business taxes",
    sourceUrl:
      "https://www.irs.gov/businesses/small-businesses-self-employed/filing-and-paying-your-business-taxes",
    sourcePublishedAt: "2025-09-08",
  ...
  // =========================
  {
    ...
    ruleText:
      "For UK VAT questions, Actic Finance may use GOV.UK VAT rate source coverage to explain that VAT rate treatment depends on the goods/services category. Current GOV.UK VAT rate categories include standard, reduced, and zero-rated treatment, with exemptions for some items. Actic Finance should not assign an exact VAT treatment to a product/service without verified category-specific rules.",
  ...
  },
  {
    ...
    ruleText:
      "Actic Finance should check whether UK taxable turnover over the relevant rolling 12-month period may exceed the VAT registration threshold. GOV.UK states that businesses must register if total taxable turnover for the last 12 months goes over £90,000. Actic Finance should not register the business or certify threshold status without complete turnover records and professional review.",
  ...
  },
  {
    ...
    ruleText:
      "Actic Finance should flag VAT Flat Rate Scheme review only as a checklist item. GOV.UK says the scheme uses a fixed rate of VAT paid to HMRC and may be available if VAT turnover is within scheme limits. Actic Finance should recommend accountant review before deciding whether the scheme is beneficial or applicable.",
  ...
  },
  {
    ...
    ruleText:
      "For UK limited-company tax questions, Actic Finance should use GOV.UK Corporation Tax rates and allowances as the source family. Actic Finance should check profit, accounting period, company status, reliefs, and complete accounts before giving readiness guidance. Actic Finance should not calculate final Corporation Tax without complete verified rules and accountant review.",
  ...
  },
  {
    ...
    ruleText:
      "For UK employers, Actic Finance should check whether payroll records, employee pay, deductions, PAYE references, pension contribution data, and period coverage are available. Actic Finance should not submit PAYE returns or certify payroll tax amounts.",
  ...
  },
  {
    ...
    ruleText:
      "For UK Self Assessment or self-employed questions, Actic Finance should check income records, expense records, invoices, bank statements, payroll if applicable, VAT records if registered, and prior submissions where available. Actic Finance should not submit a Self Assessment return or certify final liability.",
  ...
  },
  {
    ...
    ruleText:
      "For UK income-tax questions, Actic Finance may use GOV.UK tax-year rates and allowances source coverage for guidance. Actic Finance should not calculate final income tax unless full verified rules, personal circumstances, allowances, reliefs, residency status, and complete income data are available.",
  ...
  },
  {
    ...
    ruleText:
      "For UK company filing readiness, Actic Finance should check approved accounts, profit and loss data, balance sheet data, bank statements, payroll records if applicable, VAT records if registered, and corporation-tax period coverage. Actic Finance should not file accounts or tax returns.",
    sourceName: "GOV.UK",
